...
#>    <dbl> <dbl> <chr>                           <chr>                       <chr>                      
#>  1     1     1 "Жил-был (у Гъули?) петух."     б-ик1-о-й=гъоди б--о-ч1игу… "an-быть-pst-cvb(pf)-=rep …
#>  2     2     2 "Он грелся на улице(?)."        къват1и-ла=гъоди б-ик1-о-j… "улица-in-=rep an-быть-pst…
#>  3     2     3 "[Ему в ногу] воткнулась колюч… къинни-й=гъоди ццана .      "втыкаться-cvb(pf)-=rep ко…
#>  4     3     4 "Когда колючка воткнулась, [он… ццана къинни-рбигьи б-uʔ-o… "колючка втыкаться-pst.ptc…
#>  5     4     5 "Гъули не обнаружил дома Бихта… бихьтай=ло ишуишу й-ис-он-… "Бихтай-=add дома-дома f-н…
#>  6     5     6 "Оттуда пошел к Умалаю, "       б-uʔ-oн-ни=гъоди гьербади … "an-идти-pst-pst(aor)-=rep…
#>  7     6     7 "Оттуда петух пошел к Патимат." х1елеко гье-лъу-кку б-ел1-… "петух dem-dat-el an-go-ps…
#>  8     8    10 "Оттуда [петух] пошел к Ханича… гье-лъу-кку б--и-й б-uʔ-oн… "dem-dat-el an--pst(aor)-c…
#>  9     9    11 "Иди к Хурмат, ..."             хъаничай-ди=ло ен-л1и бежу… "Ханичай-erg-=add rfl-gen.…
#> 10    10    12 "Когда дошёл до двора Хурмат, … рул1-и-й Х1урмати-л1и рей-… "говорить--cvb(pf) Хурмат-…
#> 11    11    13 "Три дня не ели, мы с ней не з… рул1-и-й лъоб-гу зубу в-ук… "говорить--cvb(pf) три-num…
#> 12    12    14 "Оттуда он ушёл и дошёл до Айш… гье-лъу-кку б--и-йб--и-й б… "dem-dat-el an--pst(aor)-c…
#> 13    13    15 "Захраил …?"                    й--и-й Загьраъил-ди=ло б-у… "f--pst(aor)-cvb(pf) Захра…
#> 14    14    16 "И он пошел в село. Захраил ск… б-укъ-и-й гьеге-б=ло гьон-… "an-гнать-pst-pf dem-an-=a…
#> 15    15    17 "Оттуда снизу вверх к Исрапилу… гьегелъу-кку гьикьу=ло лъо… "там-el внизу-=add вверх -…
#> 16    16    18 "Шли-шли и пришли к Гаджи."     гье-лъу-кку б--и-йб--и-й б… "dem-dat-el an--pst(aor)-c…
#> 17    17    19 "Они поссорились (?) и прогнал… й-ейхъ-у й-ах-о-й дунял б-… "f-ругать-pst f-драться-ps…
#> 18    18    20 "Когда закончили ссориться, [п… джид-ия сабаб=ло б-ул1-и-й… "делать-fut причина-=add a…
#> 19    19    21 "На воротах Забита петух обнар… х1елеко б--и-й забити-б ка… "петух an--pst(aor)-cvb(pf…
```
