...
#>  2     2     2 "Он грелся на улице(?)."        къват1и-ла=гъоди б-ик1-о-j… "улица-in-=rep an-быть-ps…
#>  3     2     3 "[Ему в ногу] воткнулась колюч… къинни-й=гъоди ццана .      "втыкаться-cvb(pf)-=rep к…
#>  4     3     4 "Когда колючка воткнулась, [он… ццана къинни-рбигьи б-uʔ-o… "колючка втыкаться-pst.pt…
#>  5     4     5 "Гъули не обнаружил дома Бихта… бихьтай=ло ишуишу й-ис-он-… "Бихтай-=add дома-дома f-…
...
#>  8     8    10 "Оттуда [петух] пошел к Ханича… гье-лъу-кку б--и-й б-uʔ-oн… "dem-dat-el an--pst(aor)-…
...
#> 11    11    13 "Три дня не ели, мы с ней не з… рул1-и-й лъоб-гу зубу в-ук… "говорить--cvb(pf) три-nu…
#> 12    12    14 "Оттуда он ушёл и дошёл до Айш… гье-лъу-кку б--и-йб--и-й б… "dem-dat-el an--pst(aor)-…
#> 13    13    15 "Захраил …?"                    й--и-й Загьраъил-ди=ло б-у… "f--pst(aor)-cvb(pf) Захр…
#> 14    14    16 "И он пошел в село. Захраил ск… б-укъ-и-й гьеге-б=ло гьон-… "an-гнать-pst-pf dem-an-=…
#> 15    15    17 "Оттуда снизу вверх к Исрапилу… гьегелъу-кку гьикьу=ло лъо… "там-el внизу-=add вверх …
#> 16    16    18 "Шли-шли и пришли к Гаджи."     гье-лъу-кку б--и-йб--и-й б… "dem-dat-el an--pst(aor)-…
#> 17    17    19 "Они поссорились (?) и прогнал… й-ейхъ-у й-ах-о-й дунял б-… "f-ругать-pst f-драться-p…
#> 18    18    20 "Когда закончили ссориться, [п… джид-ия сабаб=ло б-ул1-и-й… "делать-fut причина-=add …
#> 19    19    21 "На воротах Забита петух обнар… х1елеко б--и-й забити-б ка… "петух an--pst(aor)-cvb(p…
```
