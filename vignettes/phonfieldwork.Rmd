...
<iframe src="https://agricolamz.github.io/phonfieldwork/additional/second_example.html" width = 800 height = 600>
  <p>Your browser does not support iframes :(</p>
</iframe>
...
```
## Error in rename_soundfiles(stimuli = my_stimuli_df$stimuli, prefix = "s1_", : There are some non-wav files:
## logging.csv
```
...
```
## Error in rename_soundfiles(stimuli = my_stimuli_df$stimuli, prefix = "s2_", : There are some non-wav files:
## logging.csv
```
...
```
## Error in tuneR::readWave(file_name, header = TRUE): File 's1/s1_tap.wav' does not exist.
```
...
```
##       file  duration
## 1 1_02.wav 0.5343991
## 2 2_01.wav 0.5866440
## 3 3_03.wav 0.6650113
```
...
```
##    id time_start   time_end    content tier     tier_name          source
## 1   1 0.00000000 0.42990930        tap    1        labels s1_all.TextGrid
## 4   1 0.00000000 0.42990930 s1_tap.wav    2 backup labels s1_all.TextGrid
...
## 2   2 0.42990930 0.91206349        tip    1        labels s1_all.TextGrid
## 5   2 0.42990930 0.91206349 s1_tip.wav    2 backup labels s1_all.TextGrid
...
## 3   3 0.91206349 1.39421769        top    1        labels s1_all.TextGrid
## 6   3 0.91206349 1.39421769 s1_top.wav    2 backup labels s1_all.TextGrid
...
```
##   id time_start  time_end content tier tier_name          source
## 1  1  0.0000000 0.4299093     tap    1    labels s1_all.TextGrid
## 2  2  0.4299093 0.9120635     tip    1    labels s1_all.TextGrid
...
```
##    id time_start  time_end content tier tier_name          source
## 8   2 0.09510719 0.2025920       æ    3           s1_all.TextGrid
## 11  5 0.53544821 0.6160618       ı    3           s1_all.TextGrid
## 14  8 1.03559934 1.1335492       ɒ    3           s1_all.TextGrid
```
