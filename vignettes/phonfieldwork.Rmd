...
<iframe src="https://agricolamz.github.io/phonfieldwork/additional/first_example.html" width = 800 height = 600>
...
![plot of chunk unnamed-chunk-32](unnamed-chunk-32-1.png)
...
![plot of chunk unnamed-chunk-33](unnamed-chunk-33-1.png)
...
![plot of chunk unnamed-chunk-34](unnamed-chunk-34-1.png)
...
![plot of chunk unnamed-chunk-39](unnamed-chunk-39-1.png)
...
![plot of chunk unnamed-chunk-40](unnamed-chunk-40-1.png)
...
```
##    id time_start   time_end content tier        source
...
```
##   s_id p_id    txt     cf hn     gls                   msa                free_trans
## 1    1    1     б-     б-  1      an Inflects any category Жил-был (у Гъули?) петух.
## 2    1    1    ик1    ик1  1    быть                    гл Жил-был (у Гъули?) петух.
## 3    1    1     -о     -о  1     pst               гл:Past Жил-был (у Гъули?) петух.
## 4    1    1     -й     -й  5 cvb(pf)    гл:Converb/Perfect Жил-был (у Гъули?) петух.
## 5    1    1 =гъоди =гъоди  1    =rep                  част Жил-был (у Гъули?) петух.
## 6    1    1     б-     б-  1      an Inflects any category Жил-был (у Гъули?) петух.
##                            text_title                                morph
...
There is also an additional function for working with the `.flextext` format that convert it to a glossed document in a `docx` or `.html` format (see examples: [`.docx`](https://github.com/agricolamz/phonfieldwork/raw/master/docs/additional/glossed_document.docx), [`.html`](https://agricolamz.github.io/phonfieldwork/additional/glossed_document.html)):
...
```
## Output created: /home/agricolamz/work/packages/phonfieldwork/vignettes/glossed_document.docx
```
...
```
## [1] "1_s1_æ.wav" "2_s1_ı.wav" "3_s1_ɒ.wav"
```
...
```
## [1] "1_s1_æ.png" "2_s1_ı.png" "3_s1_ɒ.png"
```
...
You can find the created example [here](https://agricolamz.github.io/phonfieldwork/additional/stimuli_viewer.html).
...
```
##    id time_start   time_end    content tier          source
## 1   1 0.00000000 0.42990930        tap    1 s1_all.TextGrid
## 4   1 0.00000000 0.42990930 s1_tap.wav    2 s1_all.TextGrid
## 7   1 0.00000000 0.09510719               3 s1_all.TextGrid
## 8   2 0.09510719 0.20259200          æ    3 s1_all.TextGrid
## 9   3 0.20259200 0.42990930               3 s1_all.TextGrid
## 2   2 0.42990930 0.91206349        tip    1 s1_all.TextGrid
## 5   2 0.42990930 0.91206349 s1_tip.wav    2 s1_all.TextGrid
## 10  4 0.42990930 0.53544821               3 s1_all.TextGrid
## 11  5 0.53544821 0.61606182          ı    3 s1_all.TextGrid
## 12  6 0.61606182 0.91206349               3 s1_all.TextGrid
## 3   3 0.91206349 1.39421769        top    1 s1_all.TextGrid
## 6   3 0.91206349 1.39421769 s1_top.wav    2 s1_all.TextGrid
## 13  7 0.91206349 1.03559934               3 s1_all.TextGrid
## 14  8 1.03559934 1.13354921          ɒ    3 s1_all.TextGrid
## 15  9 1.13354921 1.39421769               3 s1_all.TextGrid
```
...
```
##   id time_start  time_end content
## 1  1  0.0000000 0.4299093     tap
## 2  2  0.4299093 0.9120635     tip
## 3  3  0.9120635 1.3942177     top
```
...
```
##   id time_start   time_end content
## 1  1 0.00000000 0.09510719        
## 2  2 0.09510719 0.20259200       æ
## 3  3 0.20259200 0.42990930        
## 4  4 0.42990930 0.53544821        
## 5  5 0.53544821 0.61606182       ı
## 6  6 0.61606182 0.91206349        
## 7  7 0.91206349 1.03559934        
## 8  8 1.03559934 1.13354921       ɒ
## 9  9 1.13354921 1.39421769
```
...
```
##   id time_start  time_end content
## 2  2 0.09510719 0.2025920       æ
## 5  5 0.53544821 0.6160618       ı
## 8  8 1.03559934 1.1335492       ɒ
```
...
[Here](https://agricolamz.github.io/phonfieldwork/additional/stimuli_viewer2.html) is the result file.
