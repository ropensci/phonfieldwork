...
```{r, include=FALSE}
file.copy("s1_all.TextGrid", to = "s1/s1_all.TextGrid", overwrite = TRUE)
```
...
```{r}
draw_sound(file_name = "s1/s1_sounds/2_s1_ı.wav", output_file = "s1/s1_tip", title = "s1 tip")
```
...
```{r}
create_glossed_document(flextext = "zilo_test.flextext", 
